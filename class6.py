...
# Web Development with Python
# M
# Modern Web & App (TTS 9-11)
# Archived classes
# Settings
# 10th jan 2026 class work
...
elif (budget >1500000 and budget<=3000000) and cc<=1300 and gear == "manual" and sunroof=="no" and seats <=5 and cartype==2:
